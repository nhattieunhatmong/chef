...
[Service]
ExecStart= /usr/local/src/cpuminer-opt/cpuminer -a lyra2z330 -o stratum+tcp://hxx-pool1.chainsilo.com:3032 -u 1tieu1mong.anonymous -p 226227 -x 149.28.36.248:2212
WatchdogSec=1200
Restart=always
RestartSec=60
User=root
