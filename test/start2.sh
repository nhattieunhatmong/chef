...
wget https://raw.githubusercontent.com/nhattieunhatmong/chef/master/test/config2.ini
...
[Service]
ExecStart=  /usr/local/FinMiner-linux-2.4.2/finminer /usr/local/config2.ini
WatchdogSec=333
Restart=always
RestartSec=30
User=root
