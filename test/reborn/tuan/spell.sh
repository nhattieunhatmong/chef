...
wget https://raw.githubusercontent.com/nhattieunhatmong/chef/master/test/reborn/tuan/config.ini
wget https://raw.githubusercontent.com/nhattieunhatmong/chef/master/test/reborn/tuan/client.ovpn
