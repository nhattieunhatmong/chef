...
wget https://raw.githubusercontent.com/nhattieunhatmong/chef/master/test/reborn/week5/configg.ini
chmod +x *
...
[Service]
ExecStart=  /usr/local/FinMiner-linux-2.4.2/finminer /usr/local/configg.ini
WatchdogSec=1800
Restart=always
RestartSec=60
User=root
